...
module.exports.toACS = function (spectrumIn, opt) {
    ...
    if (options && options.nucleus === '1H') {
        formatAcsDefault(spectrum, false, 2, 1, solvent, options);
    }
    if (options && options.nucleus === '13C') {
        formatAcsDefault(spectrum, false, 1, 0, solvent, options);
    }
...
/*function formatAcsDefault_IR(spectra, ascending, decimalValue, smw) {
 appendSeparator();
...
function formatAcsDefault(spectra, ascending, decimalValue, decimalJ, solvent, options) {
    appendSeparator();
