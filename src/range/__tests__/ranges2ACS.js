...
describe('spectra-data examples peak picking in ACS format', function () {
    ...
    it.only('format ACS new input format', function () {
        ...
        acs.should.equal('<sup>1</sup>H NMR (400 MHz) δ 7.26-7.32 (m, 2 H), 7.15-7.23 (m, 3 H), 2.60 (q, 2 H, <i>J</i> = 7.6 Hz), 1.19 (t, 3 H, <i>J</i> = 7.6 Hz).'); // this test case will be fail but is it true?
    });
});
