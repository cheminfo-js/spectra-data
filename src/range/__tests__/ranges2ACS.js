...
describe('spectra-data examples peak picking in ACS format', function () {
    ...
    it('format ACS', function () {
        var peakPicking = spectrum.createRanges({'nH': 10, realTopDetection: true, thresholdFactor: 0.8, clean: true, compile: true, format: 'old', optimize: true});
    ...
    it('format ACS new input format', function () {
        var peakPicking2 = spectrum.createRanges({'nH': 10, realTopDetection: true, thresholdFactor: 0.8, clean: true, compile: true, format: 'new', optimize: true});
