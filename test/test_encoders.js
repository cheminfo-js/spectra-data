'use strict';
var Encoder = require("../src/jcampEncoder/VectorEncoder");
...
describe('Text encoders test', function () {
    it('DIFDUP should give the rigth string', function () {
        var DIFDUP = Encoder.DIFDUPencod(raw,0,1);
    ...
    it('DIFDUP should give the rigth zeros string', function () {
        var DIFDUP = Encoder.DIFDUPencod(zeros,0,1);
